 ...
 */
  ...
  export function formatMoney(money: number, decimalPlaces: number = TWO, showPositiveSign: boolean = true): string {
   ...
   */
  export function convertToPercentage(num: number | string, decimalPlaces: number = TWO, showPositiveSign: boolean = true): string {
    // 尝试将输入转换为数字
